// MoveIn8 — B2B-Seite "/fuer-studios": Pitch des Studio-Challenge-Systems an
// Fitnessstudios/Trainer, die als Partner eigene Challenges anbieten wollen.
// War früher die Startseite ("/") — die zeigt jetzt die zentrale, zielneutrale
// Übersicht (app/page.tsx), die hierher verlinkt. Nutzt das globale
// MoveIn8-CI (Orange/Grau/Olive) aus app/globals.css — gilt für die gesamte
// App außer /turnkiste (Turnkistes eigene B2C-Seite, die lokal auf die alten
// Blautöne zurück-overridet).
...
export const metadata = {
  title: 'MoveIn8 für Studios — Das Challenge-System als Lizenz',
  description:
      ...
      <header className="sticky top-0 z-30 border-b border-outline/40 bg-bg/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3">
          ...
          <nav className="hidden items-center gap-7 sm:flex">
            <Link href="/" className="text-sm font-medium text-text-muted transition hover:text-text">
              Startseite
            </Link>
        ...
        <div className="mx-auto max-w-6xl px-5 py-12">
          <div className="flex flex-col items-start justify-between gap-8 sm:flex-row">
            ...
            <div className="flex flex-col gap-2 text-sm">
              ...
              <a href="/teilnahmebedingungen" className="text-text-muted transition hover:text-text">Teilnahmebedingungen</a>
            </div>
          </div>
