// Abnehmen Challenge — B2C-Landingpage im MoveIn8-CI (Orange).
// Struktur an app/longevity-challenge/page.tsx angelehnt, Copy auf
// nachhaltige Gewichtsreduktion umgeschrieben.
...
export default function AbnehmenChallengePage() {
  return (
    <div className="min-h-screen bg-bg">
      <SiteHeader
        ctaLabel="Challenge-Plan erstellen"
        ctaHref="/abnehmen-challenge/plan"
        logoHref="/abnehmen-challenge"
        showNavLinks={false}
      />
      ...
      <main>
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-16 sm:pt-24 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
            <div>
              ...
              <h1 className="text-4xl font-semibold leading-[1.08] tracking-tight text-text sm:text-5xl lg:text-6xl">
                In 8 Wochen zu <span className="text-accent">deinem</span> Wohlfühlgewicht.
                Ohne Diät-Chaos.
              </h1>
              ...
              <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row">
                <Link href="/abnehmen-challenge/plan" className={btnPrimary + ' w-full text-center sm:w-auto'}>
          ...
          <div className="mx-auto max-w-5xl px-5 py-20 sm:py-24">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-text sm:text-4xl">
                Du hast schon alles probiert. <br />
                Und trotzdem: Jojo-Effekt.
              </h2>
              <p className="mt-5 text-base leading-relaxed text-text-muted">
                Low-Carb, Intervallfasten, die App vom letzten Sommer — kurzfristig ging was runter,
                dann war's wieder drauf. Das liegt nicht an fehlender Disziplin. Es liegt daran,
                dass generische Diäten nie auf deinen Alltag, deinen Stoffwechsel und deinen
                Lifestyle zugeschnitten sind.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-3">
              <QuoteCard
                initial="S"
                color="#d9701e"
                text="„Ich hab schon fünf Diäten durch — nach jeder war ich schwerer als vorher.“"
              />
              <QuoteCard
                initial="K"
                color="#f68b35"
                text="„Kalorien zählen klappt zwei Wochen, dann hab ich keine Lust mehr und alles bricht zusammen.“"
              />
              <QuoteCard
                initial="D"
                color="#d9701e"
                text="„Ich weiß gar nicht mehr, was jetzt eigentlich stimmt — Low-Fat, Low-Carb, Keto?“"
              />
            </div>
          </div>
        </section>
        ...
        <section id="mechanismus" className="mx-auto max-w-5xl scroll-mt-20 px-5 py-20 sm:py-28">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-base leading-relaxed text-text-muted">
              Kein Diätplan von der Stange. Dein Profil entscheidet, was du bekommst.
            </p>
          </div>
          <div className="mt-12">
            <PillarHub />
          ...
          <div className="mx-auto max-w-5xl px-5 py-20 sm:py-28">
            <div className="grid items-center gap-14 lg:grid-cols-2">
              <div>
                ...
                <h2 className="mt-4 text-3xl font-semibold tracking-tight text-text sm:text-4xl">
                  Woche 0. Woche 8. <br />
                  <span className="text-accent">Nicht nur die Waage.</span>
                </h2>
                <p className="mt-5 leading-relaxed text-text-muted">
                  Du startest mit einer Baseline — Gewicht, Energie, Sättigungsgefühl, Fitness.
              ...
              <div className="rounded-3xl bg-bg p-7 shadow-sm sm:p-8">
                ...
                <div className="space-y-5">
                  <StatBar label="Sättigungsgefühl" from={4} to={8} />
                  <StatBar label="Energie im Alltag" from={5} to={8} />
                  <StatBar label="Trainingskonsistenz" from={3} to={7} />
                  <StatBar label="Motivation" from={4} to={9} />
                </div>
          ...
          <div className="mt-14 grid grid-cols-1 gap-8 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                text: 'Komplette Transformation sichtbar — Gewicht, Energie, Training, Körpergefühl. Die Top 3 gewinnen Preise. Du gewinnst auf jeden Fall.',
              },
            ].map((s) => (
              <div key={s.step}>
        ...
        <section className="mx-auto max-w-5xl px-5 py-20 sm:py-28">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 leading-relaxed text-text-muted">
                Ob Frage zum Kaloriendefizit, zum Supplement oder zur aktuellen Wochenaufgabe —
                dein persönlicher KI-Coach kennt deine komplette Challenge und antwortet sofort.
                Kein Warten auf Rückmeldung, keine Standard-Antworten.
              </p>
              <ul className="mt-6 space-y-3">
                <Check>Kennt automatisch deinen Plan und deine Woche</Check>
                <Check>Beantwortet Ernährungs- und Supplement-Fragen fundiert</Check>
              ...
              <div className="space-y-3">
                <div className="flex justify-end">
                  <div className="max-w-[80%] rounded-2xl rounded-tr-sm bg-accent px-3.5 py-2.5 text-sm text-on-accent">
                    Muss ich wirklich jede Kalorie tracken?
                  </div>
                </div>
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="max-w-[80%] rounded-2xl rounded-tl-sm bg-bg px-3.5 py-2.5 text-sm text-text shadow-sm">
                    Nein — ein grobes Gefühl fürs Defizit reicht meistens. Ich zeig dir, worauf's ankommt …
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid items-center gap-14 lg:grid-cols-2">
              <div>
                ...
                <ul className="mt-6 space-y-3">
                  ...
                  <Check>Schlechter Schlaf bremst jede Diät — wird mitbehandelt</Check>
                  <Check>Heißhunger-Trigger werden gezielt adressiert</Check>
                </ul>
              </div>
              ...
              <div className="rounded-3xl bg-bg p-6 sm:p-8">
                ...
                {[
                  ...
                  { tier: 'Deine Basics', color: 'bg-accent', items: ['L-Carnitin', 'Vitamin B12'] },
                  { tier: 'Specials', color: 'bg-indigo-500', items: ['Chrom', 'Glucomannan'] },
                  { tier: 'Add-ons', color: 'bg-outline', items: ['Grüntee-Extrakt', 'Ballaststoffe'] },
                ].map((t) => (
        ...
        <section id="preis" className="mx-auto max-w-4xl scroll-mt-20 px-5 py-20 sm:py-28">
          ...
          <div className="mx-auto mt-12 max-w-md rounded-3xl border-2 border-accent/30 bg-surface p-8 text-center">
            <p className="text-sm font-semibold uppercase tracking-widest text-text-muted">Abnehmen Challenge</p>
        ...
        <section className="bg-surface">
          <div className="mx-auto max-w-5xl px-5 py-20 sm:py-28">
            ...
            <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {[
                { platz: '1', label: 'Platz 1', preis: 'Premium Supplement-Paket + Ernährungscoaching', border: 'border-amber-300' },
        ...
        <section className="mx-auto max-w-5xl px-5 py-20 sm:py-28">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-tight text-text sm:text-4xl">
              Nachhaltig abnehmen ist kein Trend. Es ist Physiologie.
            </h2>
            <p className="mt-4 text-base leading-relaxed text-text-muted">
              Wer Schlaf, Bewegung, Ernährung und Supplementierung strukturiert optimiert, verliert
              Gewicht ohne Jojo-Effekt. Nicht durch Verzicht. Durch System.
            </p>
          </div>

          <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { pct: 78, zahl: '−4,2 kg', label: 'Körpergewicht', text: 'im Schnitt nach 8 Wochen strukturiertem Programm' },
              { pct: 65, zahl: '−28%', label: 'Heißhunger-Episoden', text: 'bei stabilem Blutzucker durch angepasste Ernährung' },
              { pct: 72, zahl: '+23%', label: 'Muskelerhalt', text: 'bei Krafttraining + optimaler Proteinversorgung im Defizit' },
              { pct: 84, zahl: '×2.1', label: 'Durchhaltequote', text: 'gegenüber generischen Diäten ohne Coaching' },
            ].map((s) => (
        ...
        <section className="bg-surface">
          <div className="mx-auto max-w-3xl px-5 py-20 text-center sm:py-28">
            <h2 className="text-4xl font-semibold tracking-tight text-text sm:text-5xl">
              Dein Wohlfühlgewicht wartet. <br />
            ...
            <div className="mt-10 flex flex-col items-center gap-4">
              <Link href="/abnehmen-challenge/plan" className={btnPrimary + ' px-10 py-5 text-lg'}>
                Erstelle deinen Challenge-Plan →
              </Link>
      ...
      <SiteFooter tagline="Die Abnehmen Challenge — individuell auf dich abgestimmt." />
      <PresalesCoachWidget
        challengeSlug="abnehmen-challenge-1"
        challengeName="Abnehmen Challenge"
        planHref="/abnehmen-challenge/plan"
      />
    </div>
  );
}
