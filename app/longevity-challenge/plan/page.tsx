...
// aufgerufen, kein zweiter, auth-pflichtiger Request nötig).
...
export default function LongevityPlanPage() {
  ...
  async function onFinish(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.teilnahmeId) {
        router.push(`/longevity-challenge/pass/${data.teilnahmeId}`);
      } else {
          ...
          <p className="mx-auto mt-4 max-w-lg text-base leading-relaxed text-text-muted">
            {phase === 'fragen'
              ...
              : phase === 'promo'
                ...
                : 'Dein Plan ist fertig — reserviere jetzt deinen Platz in der Longevity Challenge.'}
          </p>
        </div>
