...
export const metadata = {
  ...
  description:
    'Die Longevity Lifestyle Challenge von MoveIn8: Training, Ernährung, Supplements und KI-Coaching individuell auf dich abgestimmt. 8 Wochen, echte Community, messbare Ergebnisse.',
};
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-16 sm:pt-24 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-text-muted">
                ...
                individuell auf dich berechnet, nicht auf den Durchschnitt. Mit KI-Coach,
