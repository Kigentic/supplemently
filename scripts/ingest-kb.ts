...
// ingestTrainingsplaeneAusDb kommt jetzt aus lib/kbTrainingsplaene.ts —
// gemeinsam genutzt mit dem Cron-Job app/api/cron/reingest-trainingsplaene,
// der das nach jeder Migration automatisch nachzieht.
